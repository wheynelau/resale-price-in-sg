...
if not results.empty:
    ...
    with st.expander("Additional settings (Distance and lease range)", expanded=False):
    ...
    filtered_results["month"] = (
        filtered_results["year"].astype(str)
        + "-"
        + filtered_results["month"].astype(str)
    )
    filtered_results["lease_commence_date"] = filtered_results[
        "lease_commence_date"
    ].astype(str)
